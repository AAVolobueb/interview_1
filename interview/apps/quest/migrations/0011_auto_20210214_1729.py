...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='question',
            name='answer_type',
            field=models.PositiveSmallIntegerField(default=1, verbose_name='Тип вопроса (1-ответ текстом, 2-выбор варианта, 3-выбор нескольких вариантов)'),
        ),
        migrations.AlterField(
            model_name='result_a',
            name='result',
